...
<div class="min-h-screen py-8 flex justify-center items-start px-4">
    <div class="w-full max-w-md bg-blue-100 p-5 rounded-lg shadow-md text-xs sm:text-sm">
        <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 mb-5 text-center">Edit Listing</h2>
    ...
    @endif
        <form action="{{ route('listings.update', $listing->id) }}" method="POST" enctype="multipart/form-data" class="space-y-3">
            @csrf
            @method("put")
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="2"
                    class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">{{ $listing->description }}</textarea>
            </div>
            ...
            <div class="flex items-center space-x-2">
                <input type="checkbox" name="offered" id="offered" class="text-blue-600" {{$listing->offered ? 'checked' : '' }}>
            ...
            <div>
                ...
                <input type="number" name="offeredPrice" id="offeredPrice" step="0.01" value="{{ $listing->offeredPrice }}"
                    class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">
            </div>
            ...
            <div>
                ...
                <input type="number" name="regularPrice" id="regularPrice" step="0.01" value="{{ $listing->regularPrice }}"
                    class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" name="bedrooms" id="bedrooms" min="0" value="{{ $listing->bedrooms }}"
                        class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">
                </div>
                <div>
                    <label for="bathrooms" class="block text-gray-700 mb-0.5">Bathrooms</label>
                    <input type="number" name="bathrooms" id="bathrooms" min="0" value="{{ $listing->bathrooms }}"
                        class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <label class="flex items-center space-x-1 text-gray-700">
                    <input type="checkbox" name="parking" {{ $listing->parking ? 'checked' : '' }}> <span>Parking</span>
                </label>
                <label class="flex items-center space-x-1 text-gray-700">
                    <input type="checkbox" name="furnished" {{ $listing->furnished ? 'checked' : '' }}> <span>Furnished</span>
                </label>
            </div>
            ...
            <div>
                ...
                <textarea name="address" id="address" rows="2"
                    class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">{{ $listing->address }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="text" name="latitude" id="latitude" value="{{ $listing->latitude }}"
                        class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">
                </div>
                <div>
                    <label for="longitude" class="block text-gray-700 mb-0.5">Longitude</label>
                    <input type="text" name="longitude" id="longitude" value="{{ $listing->longitude }}"
                        class="bg-blue-50 w-full border-gray-300 rounded focus:ring-blue-600 focus:border-blue-600 p-1.5">
                </div>
            </div>
